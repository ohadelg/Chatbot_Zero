...
export const SearchResult: React.FC<SearchResultProps> = ({
  ...
  return (
    <div className="flex flex-col" >
      ...
      >
        ...
        >
          ...
          <div className="inline-flex gap-4 justify-between overflow-hidden">
            <h4 className="flex flex-row-reverse space-x-reverse space-x-1.5 pb-2 text-md mb-1 font-semibold overflow-ellipsis overflow-hidden whitespace-nowrap text-blue-500 text-lg">
              {name}
            </h4>
            <ArrowDown
          ...
          <span className="rounded-md flex justify-center px-2 py-1 text-slate-400 text-xs">
            ...
            <a
            className="hover:text-blue-800 text-blue-500 text-sm overflow-ellipsis overflow-hidden whitespace-nowrap text-right"
            target="_blank"
            rel="noreferrer"
            href={url}
            >
          ...
          {summary?.map((text, index) => (
            <React.Fragment key={index}>
              ...
              <p className="text-sm mb-2 overflow-ellipsis text-black text-right" >
                ...{text}
              </p>
            </React.Fragment>
          ))}
      ...
      {updated_at && (
        <span className="self-end mt-1 text-zinc-400 text-xs tracking-tight font-medium uppercase text-right" >
