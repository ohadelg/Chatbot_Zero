    ...
    >
      ...
      {isMessageLoading ? (
        ...
        <button
          ...
          type="submit"
          className="enabled:hover:bg-blue-600 disabled:opacity-75 bg-blue-500 px-4 py-2 rounded-md border disabled:cursor-not-allowed cursor-pointer self-end absolute left-0 bottom-2"
        >
          <SendIcon width={24} height={24} style={{ transform: 'rotate(-90deg)' }} />
        </button>
      )}
    </form>
  )
